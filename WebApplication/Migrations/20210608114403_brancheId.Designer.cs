...
namespace WebApplication.Migrations
{
    ...
    [Migration("20210608114403_brancheId")]
    partial class brancheId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BranchesUsers", b =>
                {
            ...
            modelBuilder.Entity("WebApplication.Models.Branches", b =>
                {
            ...
            modelBuilder.Entity("BranchesUsers", b =>
                {
                    b.HasOne("WebApplication.Models.Branches", null)
                        .WithMany()
                        .HasForeignKey("BranchesBranchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebProject.Models.Users", null)
                        .WithMany()
